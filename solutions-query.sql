...
----- Improving Query Performance---------
 ...
 -- Planning Time : 2.048ms
 -- Excecution Time : 634.991
...
-- Planning Time : 14.594ms
-- Excecution Time : 70.293ms
...
SELECT st.store_id,st.store_name,sum(s.quantity) AS Quantity
FROM sales s
JOIN stores st ON s.store_id = st.store_id
GROUP BY st.store_id
order BY Quantity DESC;

-- 3.Identify how many sales occurred in JAN 2023.
